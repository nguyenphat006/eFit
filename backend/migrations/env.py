...
def run_migrations_offline() -> None:
    ...
    import os
    url = os.getenv("DATABASE_URL", "postgresql+asyncpg://efit_user:efit_password@db:5432/efit_db")
    context.configure(
        url=url,
...
async def run_migrations_online() -> None:
    ...
    import os
    db_url = os.getenv("DATABASE_URL", "postgresql+asyncpg://efit_user:efit_password@db:5432/efit_db")
